...
import CameraScanner from './page/CameraScanner';
      ...
      <Root>
        <Router>
          <Scene key="root">
            ...
            <Scene key="barcode" component={CameraScanner} hideNavBar />
            <Scene key="orders" component={TrackOrder} modal hideNavBar />
          </Scene>
        </Router>
      </Root>
    );
